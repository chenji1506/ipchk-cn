...
<template>
  ...
  <footer>
    ...
    <div class="one-line">
      本站基于 <a href="https://github.com/nomdn/ipw-cn" target="_blank" rel="noreferrer">nomdn/ipw-cn</a>（GPL-3.0 开源协议）构建，源码遵循 GPL v3.0，<a href="/source/" target="_blank">源码下载</a>
    </div>
    <div class="one-line">
